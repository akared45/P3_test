          ...
          <Stack spacing={1}>
            ...
            {doctor.specialty && (
              <Chip
                ...
                size="small"
                sx={{ mt: 1, bgcolor: alpha("#1976d2", 0.1), color: "#1976d2" }}
              />
            )}
          </Stack>
        </Paper>
    ...
    >
        ...
        <Box>
          <Box display="flex" alignItems="center" gap={1} mb={1}>
            ...
            <Typography variant="h5" fontWeight="bold" color="text.primary">
              {t("doctors_chart.title")}
            </Typography>
          </Box>
          <Typography variant="body2" color="text.secondary">
            {t("doctors_chart.subtitle")}
          </Typography>
        </Box>
        <Chip
          icon={<TrendingUp />}
          label={t("doctors_chart.high_performance")}
          size="small"
          sx={{
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Bar
              ...
              name={t("doctors_chart.booking_count")}
              radius={[0, 4, 4, 0]}
              barSize={16}
            >
            ...
            >
              ...
              <Box textAlign="right">
                <Typography variant="body2" fontWeight="bold" color="#3b82f6">
                  {doctor.bookingCount} {t("doctors_chart.booking_count")}
                </Typography>
      ...
      >
        <Box textAlign="center">
          <Typography variant="caption" color="text.secondary">
            {t("doctors_chart.total_revenue")}
          </Typography>
          <Typography variant="h6" fontWeight="bold" color="#2e7d32">
            {formatCurrency(
              sortedData.reduce((sum, doc) => sum + doc.totalRevenue, 0)
            )}
          </Typography>
        </Box>
        <Box textAlign="center">
          <Typography variant="caption" color="text.secondary">
            {t("doctors_chart.total_bookings")}
          </Typography>
          <Typography variant="h6" fontWeight="bold" color="#1976d2">
            {sortedData
              .reduce((sum, doc) => sum + doc.bookingCount, 0)
              .toLocaleString()}
          </Typography>
        </Box>
        <Box textAlign="center">
          <Typography variant="caption" color="text.secondary">
            {t("doctors_chart.top_doctor")}
          </Typography>
          <Typography variant="h6" fontWeight="bold" color="#ed6c02">
            {sortedData[0]?.name.split(" ").pop() || t("doctors_chart.no_data")}
          </Typography>
        </Box>
      </Box>
    </Paper>
