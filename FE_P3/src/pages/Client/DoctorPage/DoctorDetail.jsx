...
const MOCK_REVIEWS = [
  {
    ...
    date: "2024-12-01",
    content:
      "Bác sĩ rất tận tâm, hỏi bệnh kỹ và giải thích rõ ràng. Cảm thấy yên tâm hẳn.",
  },
  {
    id: 2,
    user: "Trần Văn Nam",
    rating: 4,
    date: "2024-11-20",
    content: "Tư vấn tốt, nhưng chờ kết nối hơi lâu một chút.",
  },
  {
    id: 3,
    user: "Lê Thị M.",
    rating: 5,
    date: "2024-11-15",
    content: "Bác sĩ giỏi, chuyên môn cao. Thuốc kê uống 3 ngày đã đỡ.",
  },
];
          ...
          >
            ...
            >
              ...
              <CustomTabPanel value={tabValue} index={0}>
                ...
                >
                  {doctor.bio ||
                    `Bác sĩ ${doctor.fullName} là chuyên gia đầu ngành... (Chưa cập nhật tiểu sử)`}
                </Typography>
                <Typography variant="h6" fontWeight={700} gutterBottom>
                  Thông tin nhanh
                </Typography>
                <Stack spacing={2} mt={1}>
                  <Box display="flex" gap={1.5} alignItems="center">
                    ...
                    <Typography variant="body2">
                      <strong>{doctor.yearsExperience}+ Năm</strong> kinh nghiệm
                      trong nghề
                    </Typography>
                  </Box>
                  <Box display="flex" gap={1.5} alignItems="center">
                  ...
                  <Box display="flex" gap={1.5} alignItems="center">
                    ...
                    <Typography variant="body2">
                      Công tác tại:{" "}
                      <strong>
                        {doctor.workHistory?.[0]?.place ||
                          "Phòng khám Telemedicine"}
                      </strong>
                    </Typography>
                  </Box>
                </Stack>
                      ...
                      >
                        ...
                        <Box>
                          ...
                          >
                            ...
                            {work.to ? new Date(work.to).getFullYear() : "Nay"}
                          </Typography>
                        </Box>
                      </Box>
                    ))}
              ...
              <CustomTabPanel value={tabValue} index={2}>
                ...
                >
                  ...
                  <Chip
                    label={`${MOCK_REVIEWS.length} đánh giá`}
                    size="small"
                  />
                </Box>
                <Box
